...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, existingAdmin, passwordHash, existingSettings;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    email = 'info.nutech2025@gmail.com';
                ...
                case 3:
                    _a.sent();
                    console.log("Created admin user: ".concat(email));
                    return [3 /*break*/, 5];
                case 4:
                    console.log("Admin user ".concat(email, " already exists."));
                    _a.label = 5;
                case 5: return [4 /*yield*/, prisma.siteSettings.findUnique({ where: { id: 1 } })];
                case 6:
